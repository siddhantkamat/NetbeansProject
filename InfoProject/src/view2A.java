...
public class view2A extends javax.swing.JFrame {

    /**
     * Creates new form view2A
     */
    public view2A() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (jCheckBox1.isSelected() == true) {
                query = "select *from chemTb2 where CName='" + jTextField1.getText() + "';";
            } else {
                query = "select *from chemTb2 where year(dateOfEntry)=" + S1 + ";";
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://"
                    + "localhost/project", "root", "");
            Statement stmt = con.createStatement();
            String query = "select TotalTransact from chemTb2 where"
                    + " year(dateOfEntry)=" + S1 + ";";
            ResultSet rs = stmt.executeQuery(query);
            Double s = 0.0;
            while (rs.next()) {
...
jCheckBox1.setSelected(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view2A.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
